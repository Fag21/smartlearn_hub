...
from .models import Note, NoteCategory, NoteTag, NoteVersion
...
class NoteDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['can_edit'] = context['is_owner']  # Simplified for now
        return context
...
def generate_ai_summary(request, pk):
    ...
    # Simple AI summary implementation
    if note.content:
        # Create a simple summary (first 100 chars + ellipsis)
